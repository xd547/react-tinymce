...
const TinyMCE = createReactClass({
  ...
  componentWillReceiveProps(nextProps) {
    let propsConfig = clone(this.props.config)
    let nextPropsConfig = clone(nextProps.config)
    propsConfig.images_upload_handler = null
    nextPropsConfig.images_upload_handler = null
    if (!isEqual(propsConfig, nextPropsConfig) || !isEqual(this.props.id, nextProps.id)) {
